...
Connection conn;
    ...
    st = conn.createStatement();
     ...
     public void creat_employee(emplyee_username p) throws SQLException {
        // Creating Sql Statement
         dbconnection o=new dbconnection();

        String sql = "insert into employee_login values ('" + p.getCustomer_username()+ "'," + p.getCustomer_pass()+ ");";
